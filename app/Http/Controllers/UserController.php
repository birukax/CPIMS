        ...
        if ($userRole === 1) {
            ...
            return view(
                ...
                [
                    ...
                    'final_decision' => Crime::all()->where('status', 3),
            ...
            return view(
                ...
                [
                    ...
                    'police' => User::all()->where('role_id', 1),
                    'sl' => User::all()->where('role_id', 2),
                    'co' => User::all()->where('role_id', 3),
                    'admin' => User::all()->where('role_id', 4),
                    'dc' => User::all()->where('role_id', 5),
                    'count' => 0
                ]
            );
        } elseif ($userRole === 5) {
