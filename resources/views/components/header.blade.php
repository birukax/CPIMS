    ...
    <div class="flex items-center justify-between flex-grow mx-2 items-right md:px-6 2xl:px-11">
        ...
        <div class="flex gap-3 items-right 2xsm:gap-7">
            <form action="/logout" method="post">
                @csrf
                <button type="submit"
                    class="inline-flex items-center justify-center gap-1 px-3 py-1 text-center text-white rounded-full bg-dark font-small xl:font-medium hover:bg-opacity-90 lg:px-2 xl:px-5">
                    <span>
