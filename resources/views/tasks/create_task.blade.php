                        ...
                        <div class="items-center w-full">
                            <div class="flex-col w-11/12 mx-auto">
                                    ...
                                    <div class="flex gap-3">
                                        ...
                                        <div class="relative" data-te-format24="true" id="timepicker-format"
                                            ...
                                            <input type="text"
                                                ...
                                                data-te-toggle="timepicker" name="starting_time" id="starting_time" />
                                ...
                                <div class="mb-[0.125rem]  flex min-h-[1.5rem]">
                                    <x-label class="mr-1" for="zone_id" value="{{ __('Zone:') }}" />
                                    <!--Default checkbox-->
                                    <div class="mb-[0.125rem] gap-4 min-h-[1.5rem] flex">
